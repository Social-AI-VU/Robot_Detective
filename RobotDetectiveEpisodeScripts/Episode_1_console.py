...
===============================================================================
Console-only version: prints every generated line to stdout instead of sending it to TTS.
"""
import os
import sys
...
if __name__ == '__main__':
    ...
    # Console-only TTS: prints spoken text to stdout instead of sending it to ElevenLabs.
    tts = NullTTSProvider()
